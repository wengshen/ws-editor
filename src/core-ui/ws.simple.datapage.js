...
ws.SimpleDataPage = function(parent,assignDataParent, options, chartPreview, chartFrame, props) {
  var events = ws.events(),
    ...
    container = ws.dom.cr(
      'div',
      'ws-transition ws-toolbox ws-simple-toolbox ws-box-size'
    ),
    ...
    body = ws.dom.cr(
      'div',
      'ws-toolbox-body ws-simple-toolbox-body ws-datapage-body ws-box-size ws-transition'
    ),
    ...
    assignDataPanel = ws.AssignDataPanel(assignDataParent, dataTable, 'simple'),
