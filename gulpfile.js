...
gulp.task('cache-thumbnails', ['bake-thumbnails'], function () {
  return gulp.src('generated_src/ws.meta.images.js')
             // .pipe(gulp.dest(dest))
...
gulp.task('lint-advanced', function () {
  return gulp.src(sources.concat(['./generated_src/ws.meta.options.advanced.js']))
         .pipe(jslint({
        //  global: ['XMLHttpRequest']
         }))
         .pipe(jslint.reporter('default', {}))
...
gulp.task('minify-advanced', ['bake-advanced', 'less'], function () {
    return gulp.src('./generated_src/ws.meta.options.advanced.js')
